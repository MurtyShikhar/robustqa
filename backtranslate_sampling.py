...
queries_bleu = compute_backtrans_bleu(args.sample_queries_dir, args.back_dropped_queries_dir, sample_idx)
print('Queries back translation BLEU: {}'.format(queries_bleu))

context_bleu = compute_backtrans_bleu(args.sample_context_dir, args.back_dropped_context_dir, sample_idx)

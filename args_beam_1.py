...
def get_train_test_args():
    ...
    parser.add_argument('--sample_queries_dir', type=str, default='queries/beam_1/sample_queries.txt')
    parser.add_argument('--sample_context_dir', type=str, default='queries/beam_1/sample_context.txt')
    ...
    parser.add_argument('--dropped_context_dir', type=str, default='queries/beam_1/trans_en_es_context_dropped.txt')

...
def get_train_test_args():
    ...
    parser.add_argument('--sample_queries_dir', type=str, default='queries/beam_5/sample_queries.txt')
    parser.add_argument('--sample_context_dir', type=str, default='queries/beam_5/sample_context.txt')
    
    # where to retrieve the translated queries and context
    parser.add_argument('--trans_queries_dir', type=str, default='queries/beam_5/trans_en_es_queries_beam_5.txt')
    ...
    parser.add_argument('--trans_context_dir', type=str, default='queries/beam_5/sample_context.txt')
    
    # where to store the blank line dropped translated queries and context
    parser.add_argument('--dropped_queries_dir', type=str, default='queries/beam_5/trans_en_es_queries_beam_5_dropped.txt')
    parser.add_argument('--dropped_context_dir', type=str, default='queries/beam_5/trans_en_es_context_dropped.txt')
    
    parser.add_argument('--backtranslate_queries_dir', type=str, default='queries/beam_5/backtranslate_queries.txt')
    parser.add_argument('--backtranslate_context_dir', type=str, default='queries/beam_5/backtranslate_context.txt')
